...
function EquationWindow(config) {
	...
	var genericHelp = {
		...
		Stock: "The initial value of the stock will be set by this equation. Flows can increase or decrease the stock's value over time.",
		Variable: "The variable will take on the value specified by this equation. The value will be recalculated continuously.",
